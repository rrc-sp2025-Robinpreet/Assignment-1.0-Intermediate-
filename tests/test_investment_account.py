...
class TestInvestmentAccount(unittest.TestCase):
    ...
    def test_init_valid_attributes(self):
        ...
        self.assertEqual(account._InvestmentAccount__management_fee, 1.99)

    def test_init_invalid_management_fee(self):
        account = InvestmentAccount(
            2004, 622, 500.00, date.today(), management_fee="invalid"
        )
    ...
    def test_get_service_charges_created_more_than_10_years(self):
        ...
        # According to your strategy → charge = 0
        self.assertEqual(account.get_service_charges(), 0)
    ...
    def test_get_service_charges_account_exactly_10_years(self):
        ...
        # exactly 10 years counts as NOT greater
        self.assertEqual(account.get_service_charges(), 0)
    ...
    def test_get_service_charges_date_within_10_years(self):
        ...
        self.assertEqual(account.get_service_charges(), 2.55)
